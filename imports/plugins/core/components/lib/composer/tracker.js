...
/**
 * @file **MOC Components API** - Most of the React components in the MOC UI can be replaced or extended with the API outlined here. This allows anyone to create a custom plugin that can easily change the look of the UI and/or extend its functionality without having to edit core MOC code. See {@link https://docs.reactioncommerce.com/reaction-docs/trunk/components-api full tutorial and documentation}.
 *
