/**
 * @file Route Hook Methods - The Router.Hooks namespace provides a router-agnostic API for registering functions to be called either on specific routes or on every route. Read more about [Routing in MOC](https://docs.reactioncommerce.com/reaction-docs/trunk/routing).
 *
